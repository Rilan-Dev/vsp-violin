      ...
      <div className="mx-auto px-5 sm:px-8" style={{ maxWidth: "1200px", paddingTop: "40px", paddingBottom: "80px" }}>
        ...
        <section style={{ marginBottom: "64px" }}>
          ...
          <div className="flex flex-col" style={{ gap: "12px" }}>
            {dated.map((h, i) => (
              ...
              >
                {/* Year */}
                <p style={{ fontFamily: "var(--font-marcellus), serif", fontSize: "36px", color: "#E0BC6A", margin: "0 0 8px", lineHeight: 1 }}>
                  {h.year}
                </p>
                {/* Title + meaning */}
                <h2 style={{ fontFamily: "var(--font-marcellus), serif", fontSize: "22px", color: "#F3EDDF", margin: 0, lineHeight: 1.3 }}>
                  {h.title}
                </h2>
                <p style={{ fontSize: "14px", color: "rgba(243,237,223,0.72)", margin: "4px 0 12px", fontStyle: "italic" }}>
                  {h.meaning}
                </p>
                {/* Awarded by */}
                {h.awardedBy && (
                  <div style={{ borderTop: "1px solid rgba(243,237,223,0.12)", paddingTop: "10px" }}>
                    <p style={{ fontFamily: "var(--font-geist-mono), monospace", fontSize: "10px", letterSpacing: "0.16em", textTransform: "uppercase", color: "rgba(243,237,223,0.5)", margin: 0 }}>
                      Awarded by
                    </p>
                    <p style={{ fontFamily: "var(--font-instrument-sans)", fontSize: "13.5px", color: "#F3EDDF", margin: "4px 0 0" }}>
                      {h.awardedBy}
                    </p>
                  </div>
                )}
        ...
        {undated.length > 0 && (
          <section style={{ marginBottom: "64px" }}>
            ...
            <h2 style={{ fontFamily: "var(--font-marcellus), serif", fontSize: "24px", margin: "10px 0 24px", color: "#F3EDDF" }}>
        ...
        <div style={{ textAlign: "center", paddingTop: "32px", borderTop: "1px solid rgba(224,188,106,0.2)" }}>
          <p style={{ fontFamily: "var(--font-marcellus), serif", fontSize: "22px", color: "#F3EDDF", marginBottom: "20px" }}>
